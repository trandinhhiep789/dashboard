...
import { PARTNER_PRODUCT_MAP_TYPE_UPDATE } from "../../../../constants/functionLists";
...
class EditCom extends React.Component {
    ...
    handleSubmitInsertLog(MLObject) {
        MLObject.ActivityTitle = `Cập nhật loại bảng mã sản phẩm của đối tác: ${MLObject.PartnerProductMapTypeName}`;
        MLObject.ActivityDetail = `Cập nhật loại bảng mã sản phẩm của đối tác: ${MLObject.PartnerProductMapTypeName} ${"\n"}Mô tả: ${MLObject.Description}`;
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <SimpleForm
                    FormName="Cập nhật loại bảng mã sản phẩm của đối tác"
                    ...
                    ref={this.searchref}
                    RequirePermission={PARTNER_PRODUCT_MAP_TYPE_UPDATE}
                    BackLink={BackLink}
                />
            );
        }
