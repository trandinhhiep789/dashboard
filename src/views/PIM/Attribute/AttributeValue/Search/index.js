...
class SearchCom extends React.Component {
    ...
    handleSubmitInsertLog() {
        let MLObject = {};
        MLObject.ActivityTitle = "Xóa giá trị thuộc tính";
        MLObject.ActivityDetail = "Xóa giá trị thuộc tính";
        ...
        return (
            <React.Fragment>
                ...
                <DataGrid
                    ...
                    ref={this.gridref}
                    hasSearch={false}
                    RequirePermission={ATTRIBUTE_VALUE_VIEW}
                    DeletePermission={ATTRIBUTE_VALUE_DELETE}
                    IsAutoPaging={true}
                    RowsPerPage={10}
                />
            </React.Fragment>
