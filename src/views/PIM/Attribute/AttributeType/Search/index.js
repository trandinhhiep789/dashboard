...
class SearchCom extends React.Component {
    ...
    handleSubmitInsertLog() {
        let MLObject = {};
        MLObject.ActivityTitle = "Xóa loại thuộc tính";
        MLObject.ActivityDetail = "Xóa loại thuộc tính";
        ...
        return (
            <React.Fragment>
                ...
                <DataGrid
                    ...
                    ref={this.gridref}
                    RequirePermission={ATTRIBUTE_TYPE_VIEW}
                    DeletePermission={ATTRIBUTE_TYPE_DELETE}
                    IsAutoPaging={true}
                    RowsPerPage={10}
                />
            </React.Fragment>
