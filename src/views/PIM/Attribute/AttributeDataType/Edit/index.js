...
import { ATTRIBUTE_DATA_TYPE_UPDATE } from "../../../../../constants/functionLists";
...
class EditCom extends React.Component {
    ...
    handleSubmitInsertLog(MLObject) {
        MLObject.ActivityTitle = `Cập nhật loại dữ liệu thuộc tính: ${MLObject.AttributeDataTypeName}`;
        MLObject.ActivityDetail = `Cập nhật loại dữ liệu thuộc tính: ${MLObject.AttributeDataTypeName} ${"\n"}Mô tả: ${MLObject.Description}`;
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <SimpleForm
                    FormName="Cập nhật loại dữ liệu thuộc tính sản phẩm"
                    ...
                    BackLink={BackLink}
                    RequirePermission={ATTRIBUTE_DATA_TYPE_UPDATE}
                    ref={this.searchref}
                />
            );
        }
