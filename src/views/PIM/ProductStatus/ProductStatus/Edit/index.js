...
import { PRODUCT_STATUS_UPDATE } from "../../../../../constants/functionLists";
...
class EditCom extends React.Component {
            ...
            if (apiResult.IsError) {
                ...
                if (apiResult.ResultObject) {
                    const ResultLanguage = Object.assign(
                        ...
                        apiResult.ResultObject.ResultLanguage
                    );
    ...
    handleSubmitInsertLog(MLObject) {
        MLObject.ActivityTitle = `Cập nhật trạng thái: ${MLObject.ProductStatusName}`;
        MLObject.ActivityDetail = `Cập nhật trạng thái: ${MLObject.ProductStatusName} ${"\n"}Mô tả: ${MLObject.ProductStatusName}`;
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <FormContainer
                    FormName="Cập trạng thái sản phẩm"
                    name="ProductStatus"
