...
import { PRODUCT_OPRERATION_UPDATE } from "../../../../constants/functionLists";
class EditCom extends React.Component {
    ...
    handleSubmitInsertLog(MLObject) {
        MLObject.ActivityTitle = `Cập nhật tác vụ liên quan: ${MLObject.ProductOperationName}`;
        MLObject.ActivityDetail = `Cập nhật tác vụ liên quan: ${MLObject.ProductOperationName} ${"\n"}Mô tả: ${MLObject.Description}`;
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <FormContainer
                    ...
                    IsAutoLayout={true}
                    BackLink={BackLink}
                    RequirePermission={PRODUCT_OPRERATION_UPDATE}
