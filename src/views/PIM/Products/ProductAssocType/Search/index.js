...
import {
    PRODUCT_ASSOC_TYPE_VIEW,
    PRODUCT_ASSOC_TYPE_DELETE
...
class SearchCom extends React.Component {
    ...
    handleSubmitInsertLog() {
        let MLObject = {};
        MLObject.ActivityTitle = "Xóa loại kết hợp sản phẩm";
        MLObject.ActivityDetail = "Xóa loại kết hợp sản phẩm";
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <SearchForm
                    FormName="Danh sách nhóm đặc điểm sản phẩm"
                ...
                <DataGrid
                    ...
                    hasSearch={false}
                    IsAutoPaging={true}
                    RequirePermission={PRODUCT_ASSOC_TYPE_VIEW}
                    DeletePermission={PRODUCT_ASSOC_TYPE_DELETE}
                    RowsPerPage={10}
                />
            </React.Fragment>
        );
