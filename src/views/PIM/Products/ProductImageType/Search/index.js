...
import {
    PRODUCT_IMAGETYPE_VIEW,
    PRODUCT_IMAGETYPE_DELETE
...
class SearchCom extends React.Component {
    ...
    handleSubmitInsertLog() {
        let MLObject = {};
        MLObject.ActivityTitle = "Xóa loại ảnh sản phẩm";
        MLObject.ActivityDetail = "Xóa loại ảnh sản phẩm";
        ...
        return (
            <React.Fragment>
                ...
                <DataGrid
                    ...
                    ref={this.gridref}
                    RequirePermission={PRODUCT_IMAGETYPE_VIEW}
                    DeletePermission={PRODUCT_IMAGETYPE_DELETE}
                    IsAutoPaging={true}
                    RowsPerPage={10}
                />
            </React.Fragment>
