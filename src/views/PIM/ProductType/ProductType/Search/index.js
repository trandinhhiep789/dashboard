...
class SearchCom extends React.Component {
    ...
    handleSubmitInsertLog() {
        let MLObject = {};
        MLObject.ActivityTitle = "Xóa loại sản phẩm";
        MLObject.ActivityDetail = "Xóa loại sản phẩm";
        ...
        return (
            <React.Fragment>
                ...
                <DataGrid
                    ...
                    ref={this.gridref}
                    IsAutoPaging={true}
                    RequirePermission={PRODUCT_TYPE_VIEW}
                    DeletePermission={PRODUCT_TYPE_DELETE}
                    RowsPerPage={20}
                />
