...
class ProductTypeInventoryStatusCom extends Component {
    constructor(props) {
        super(props);
        this.state = {
            DataSource: [],
            ...
            return (
                <Collapsible trigger="Trạng thái tồn kho của một loại sản phẩm" easing="ease-in" open={true}>
                    <InputGrid name="GridProductTypeAttribute" controltype="GridControl"
                        title="Trạng thái tồn kho của một loại sản phẩm"
...
const ProductTypeInventoryStatus = connect(mapStateToProps, mapDispatchToProps)(ProductTypeInventoryStatusCom);
export default ProductTypeInventoryStatus;