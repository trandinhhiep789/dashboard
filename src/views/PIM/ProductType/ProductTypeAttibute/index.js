...
class ProductTypeAttibuteCom extends Component {
    constructor(props) {
        super(props);
        this.state = {
            DataSource: [],
    ...
    render() {
        if(this.state.IsLoadComplete){
            return (
                <Collapsible trigger="Các thuộc tính của một loại sản phẩm" easing="ease-in" open={true}>
                    <InputGrid name="GridProductTypeAttribute" controltype="GridControl"
                        title="Thuộc tính của một loại sản phẩm"
...
const ProductTypeAttibute = connect(mapStateToProps, mapDispatchToProps)(ProductTypeAttibuteCom);
export default ProductTypeAttibute;