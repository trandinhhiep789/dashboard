...
class SearchCom extends React.Component {
    ...
    handleSubmitInsertLog() {
        let MLObject = {};
        MLObject.ActivityTitle = "Xóa đặc điểm sản phẩm";
        MLObject.ActivityDetail = "Xóa đặc điểm sản phẩm";
    ...
    handleClearLocalCache() {
        const CacheKeyID = "PIMCACHE.PRODUCTFEATURE";
    ...
    handleGetCache() {
        this.props.callGetCache("PIMCACHE.PRODUCTFEATURE").then((result) => {
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <SearchForm
                    FormName="Danh sách đặc điểm sản phẩm"
                ...
                <DataGrid
                    ...
                    IsAutoPaging={true}
                    RequirePermission={PRODUCT_FEATURE_VIEW}
                    DeletePermission={PRODUCT_FEATURE_DELETE}
                    RowsPerPage={10}
                />
            </React.Fragment>
        );
