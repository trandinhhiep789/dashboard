...
class SearchCom extends React.Component {
    ...
    handleSubmitInsertLog() {
        let MLObject = {};
        MLObject.ActivityTitle = "Xóa nhóm đặc điểm sản phẩm";
        MLObject.ActivityDetail = "Xóa nhóm đặc điểm sản phẩm";
        ...
        return (
            <React.Fragment>
                ...
                <DataGrid
                    ...
                    ref={this.gridref}
                    RequirePermission={PRODUCT_FEATURE_GROUP_VIEW}
                    DeletePermission={PRODUCT_FEATURE_GROUP_DELETE}
                    IsAutoPaging={true}
                    RowsPerPage={10}
                />
            </React.Fragment>
