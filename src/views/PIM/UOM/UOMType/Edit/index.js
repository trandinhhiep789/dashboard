...
import { UOM_TYPE_UPDATE } from "../../../../../constants/functionLists";
...
class EditCom extends React.Component {
    ...
    handleSubmitInsertLog(MLObject) {
        MLObject.ActivityTitle = `Cập nhật loại đơn vị: ${MLObject.UOMTypeName}`;
        MLObject.ActivityDetail = `Cập nhật loại đơn vị: ${MLObject.UOMTypeName} ${"\n"}Mô tả: ${MLObject.Description}`;
            ...
            return (
                <React.Fragment>
                    <SimpleForm
                        ...
                        RequirePermission={UOM_TYPE_UPDATE}
                        BackLink={BackLink}
                    />
                </React.Fragment>
            );
