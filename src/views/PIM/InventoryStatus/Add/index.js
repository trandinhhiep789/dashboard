...
import { INVENTORY_STATUS_ADD } from "../../../../constants/functionLists";
...
class AddCom extends React.Component {
    ...
    handleSubmitInsertLog(MLObject) {
        MLObject.ActivityTitle = `Thêm mới trạng thái tồn kho: ${MLObject.InventoryStatusName}`;
        MLObject.ActivityDetail = `Thêm mới trạng thái tồn kho: ${MLObject.InventoryStatusName} ${"\n"}Mô tả: ${MLObject.Description}`;
    ...
    render() {
        ...
        return (
            <SimpleForm
                ...
                FormName="Thêm trạng thái tồn kho"
                MLObjectDefinition={MLObjectDefinition}
                listelement={AddElementList}
                onSubmit={this.handleSubmit}
                FormMessage={this.state.CallAPIMessage}
                IsErrorMessage={this.state.IsCallAPIError}
                RequirePermission={INVENTORY_STATUS_ADD}
                BackLink={BackLink}
