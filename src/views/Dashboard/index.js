    ...
    this.props.callFetchAPI(APIHostName, SearchAPIPath, postData).then(apiResult => {
      if (!apiResult.IsError) {
        this.setState({
          ...
          WeekShipmentOrderCoord:
            apiResult.ResultObject == null ? [] : apiResult.ResultObject.WeekShipmentOrderCoordList,
          ShipmentOrderActionLogList:
            apiResult.ResultObject == null ? [] : apiResult.ResultObject.ShipmentOrder_ActionLogList,
