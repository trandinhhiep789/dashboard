...
import { MD_LEADORDERSTEP_VIEW, MD_LEADORDERSTEP_DELETE } from './../../../../../constants/functionLists';
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm danh sách bước xử lý của mối bán hàng"
                    ...
                    <DataGrid
                        ...
                        ref={this.gridref}
                        RequirePermission={MD_LEADORDERSTEP_VIEW}
                        DeletePermission={MD_LEADORDERSTEP_DELETE}
                        IsAutoPaging={true}
                        RowsPerPage={10}
                    />
                </React.Fragment>
