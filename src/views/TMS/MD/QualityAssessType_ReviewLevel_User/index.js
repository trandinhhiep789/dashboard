...
import { GET_CACHE_USER_FUNCTION_LIST, MTRETURNREQUESTTYPE_ADD, MTRETURNREQUESTTYPE_DELETE, QUALITYASSESSTYPE_ADD, QUALITYASSESSTYPE_DELETE } from "../../../../constants/functionLists";
import ReviewLevel_User from "./Components/ReviewLevel_User";

class QualityAssessType_ReviewLevel_UserCom extends React.Component {
    constructor(props) {
        super(props);
...
const QualityAssessType_ReviewLevel_User = connect(mapStateToProps, mapDispatchToProps)(QualityAssessType_ReviewLevel_UserCom);
export default QualityAssessType_ReviewLevel_User;
