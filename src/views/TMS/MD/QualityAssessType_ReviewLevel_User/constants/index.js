...
export const AddAPIPath = "api/QualityAssessType_ReviewLevel_User/Add";
export const UpdateAPIPath = "api/QualityAssessType_ReviewLevel_User/Update";
export const DeleteAPIPath = "api/QualityAssessType_ReviewLevel_User/Delete";
