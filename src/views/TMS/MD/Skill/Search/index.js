...
import { SKILL_VIEW, SKILL_DELETE } from "../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm danh sách kỹ năng"
                    ...
                    <DataGrid
                        ...
                        ref={this.gridref}
                        RequirePermission={SKILL_VIEW}
                        DeletePermission={SKILL_DELETE}
                        IsAutoPaging={true}
                        RowsPerPage={10}
                    />
                </React.Fragment>
