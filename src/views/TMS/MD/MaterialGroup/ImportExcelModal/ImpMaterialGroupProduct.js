...
import {
    AddMaterialGroupProductByFileAPIPath,
    APIHostName,
    lstColMaterialGroupProductImportExcelModal,
} from '../constants';
...
class ImpMaterialGroupProductCom extends React.Component {
    constructor(props) {
        super(props);
    ...
    returnHeadingTitle() {
        return (
            <React.Fragment>
                <h5 className="d-flex mb-2">Danh sách sản phẩm của nhóm vật tư<i><small className="text-danger">&nbsp;(Chỉ chấp nhận những dòng hợp lệ)</small></i></h5>
    ...
    handleSubmit() {
        ...
        this.props.callFetchAPI(APIHostName, AddMaterialGroupProductByFileAPIPath, uptDataSubmit).then(apiResult => {
    ...
    render() {
        return <React.Fragment>
            ...
            <DataGrid
                ...
                listColumn={lstColMaterialGroupProductImportExcelModal}
                PKColumnName={""}
                RowsPerPage={10}
            />
        </React.Fragment>
...
ImpMaterialGroupProductCom.defaultProps = {
    importData: {
        rows: [],
        errors: []
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(ImpMaterialGroupProductCom);