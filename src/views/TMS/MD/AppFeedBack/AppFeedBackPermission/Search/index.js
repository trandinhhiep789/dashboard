...
import { APPFEEDBACKPERMISSION_VIEW, APPFEEDBACKPERMISSION_DELETE } from "../../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm quyền trên phản hồi"
                    ...
                    <DataGrid
                        ...
                        ref={this.gridref}
                        RequirePermission={APPFEEDBACKPERMISSION_VIEW}
                        DeletePermission={APPFEEDBACKPERMISSION_DELETE}
                        IsAutoPaging={true}
                        RowsPerPage={10}
                    />
                </React.Fragment>
