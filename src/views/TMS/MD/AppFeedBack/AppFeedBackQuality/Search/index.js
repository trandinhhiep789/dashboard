...
import { APPFEEDBACKQUALITY_VIEW, APPFEEDBACKQUALITY_DELETE } from "../../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm chất lượng xử lý phản hồi"
                    ...
                    <DataGrid
                        ...
                        ref={this.gridref}
                        RequirePermission={APPFEEDBACKQUALITY_VIEW}
                        DeletePermission={APPFEEDBACKQUALITY_DELETE}
                        IsAutoPaging={true}
                        RowsPerPage={10}
                    />
                </React.Fragment>
