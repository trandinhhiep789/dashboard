...
import { APPFEEDBACKSTATUS_VIEW, APPFEEDBACKSTATUS_DELETE } from "../../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm trạng thái phản hồi"
                    ...
                    <DataGrid
                        ...
                        ref={this.gridref}
                        RequirePermission={APPFEEDBACKSTATUS_VIEW}
                        DeletePermission={APPFEEDBACKSTATUS_DELETE}
                        IsAutoPaging={true}
                        RowsPerPage={10}
                    />
                </React.Fragment>
