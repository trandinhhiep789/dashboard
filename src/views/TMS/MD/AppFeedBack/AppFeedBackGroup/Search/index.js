...
import { APPFEEDBACKGROUP_VIEW, APPFEEDBACKGROUP_DELETE } from "../../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm phân loại phản hồi"
                    ...
                    <DataGrid
                        ...
                        ref={this.gridref}
                        RequirePermission={APPFEEDBACKGROUP_VIEW}
                        DeletePermission={APPFEEDBACKGROUP_DELETE}
                        IsAutoPaging={true}
                        RowsPerPage={10}
                    />
                </React.Fragment>
