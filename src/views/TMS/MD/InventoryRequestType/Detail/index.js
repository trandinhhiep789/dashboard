...
import InventoryRequestType_Product from "../../InventoryRequestType_Product";
import InventoryRequestType_ReviewLevel from "../../InventoryRequestType_ReviewLevel";
        ...
        if (this.state.IsLoadDataComplete && !this.state.IsCallAPIError) {
            return (
                <React.Fragment>
                    <div className="col-md-12 col-sm-12 col-xs-12">
                        <div className="x_panel">
                            <div className="x_title">
                                <h2>Thông tin loại yêu cầu kiểm kê</h2>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <span>Mã loại yêu cầu kiểm kê: </span>
                                            <span className="xcode">{this.state.DataSource.InventoryRequestTypeID}</span>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <span>Tên loại yêu cầu kiểm kê: </span>
                                            <span>{this.state.DataSource.InventoryRequestTypeName}</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <br />
                    <InventoryRequestType_Product
                        InventoryRequestTypeID={this.props.match.params.id}
                        InventoryRequestType_Product_DataSource={this.state.DataSource.ListInventoryRequestType_Product ? this.state.DataSource.ListInventoryRequestType_Product : []}
