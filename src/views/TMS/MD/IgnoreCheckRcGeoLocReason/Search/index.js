...
import { SERVICETYPE_VIEW, SERVICETYPE_DELETE, REWARDTYPE_VIEW, REWARDTYPE_DELETE, QUALITYASSESSGROUP_VIEW, QUALITYASSESSGROUP_DELETE, SHIPMENTORDERTYPE_VIEW, SHIPMENTORDERTYPE_DELETE } from "../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm lý do bỏ qua kiểm tra tọa độ nhận hàng"
