...
import { QUALITYASSESSGROUP_UPDATE, REWARDTYPE_UPDATE, SERVICETYPE_UPDATE, SHIPMENTORDERTYPE_UPDATE } from "../../../../../constants/functionLists";
...
class EditCom extends React.Component {
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <SimpleForm
                    FormName="Cập nhật lý do bỏ qua kiểm tra tọa độ nhận hàng"
