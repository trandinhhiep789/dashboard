...
import AdvanceRequestType_ReviewLevel_User from "../../AdvanceRequestType_ReviewLevel_User";
    ...
    callLoadData() {
        ...
        this.props.callFetchAPI(APIHostName, LoadAPIPath, id).then(apiResult => {
            if (apiResult.IsError) {
                ...
                const detailID = apiResult.ResultObject.AdvanceRequestTypeID;
                const DetailPagePath = [
                    { Link: "/", Title: "Trang chủ", icon: "fa fa-home" },
                    { Link: "/AdvanceRequestType", Title: "Loại yêu cầu tạm ứng" },
                    { Link: "/AdvanceRequestType/Detail/" + detailID, Title: "Chi tiết loại yêu cầu tạm ứng" },
        ...
        if (this.state.IsLoadDataComplete && !this.state.IsCallAPIError) {
            return (
                <React.Fragment>
                    ...
                    <br />
                    <AdvanceRequestType_ReviewLevel_User
                        ReviewLevelID={this.props.match.params.id}
                        AdvanceRequestType_ReviewLevel_User_DataSource={this.state.DataSource.ListAdvanceRequestType_ReviewLevel_User ? this.state.DataSource.ListAdvanceRequestType_ReviewLevel_User : []}
