...
export const AddAPIPath = "api/AdvanceRequestType_ReviewLevel/Add";
export const UpdateAPIPath = "api/AdvanceRequestType_ReviewLevel/Update";
export const DeleteAPIPath = "api/AdvanceRequestType_ReviewLevel/Delete";
export const LoadAPIPath = "api/AdvanceRequestType_ReviewLevel/Load";
...
export const DetailPagePath = [
    ...
    //{ Link: "/AdvanceRequestType/ReviewLevelDetail", Title: "Mức duyệt" },
...
export const DataGridColumnList = [
    ...
    },
    {
        Name: "ReviewLevelName",
        Type: "texttolink",
        Link: "/AdvanceRequestType/ReviewLevelDetail/",
