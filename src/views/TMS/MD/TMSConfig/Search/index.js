...
import { TMSCONFIG_VIEW, TMSCONFIG_DELETE } from "../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm cấu hình hệ thống TMS"
                    ...
                    <DataGrid
                        ...
                        ref={this.gridref}
                        RequirePermission={TMSCONFIG_VIEW}
                        DeletePermission={TMSCONFIG_DELETE}
                        IsAutoPaging={true}
                        RowsPerPage={10}
                    />
                </React.Fragment>
