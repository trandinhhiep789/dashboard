...
import { SERVICETYPE_VIEW, SERVICETYPE_DELETE, REWARDTYPE_VIEW, REWARDTYPE_DELETE, QUALITYASSESSGROUP_VIEW, QUALITYASSESSGROUP_DELETE, APPFEEDBACKTYPE_VIEW, APPFEEDBACKTYPE_DELETE } from "../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm loại đồng bộ dữ liệu giữa các ứng dụng"
