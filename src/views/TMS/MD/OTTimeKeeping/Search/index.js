...
import { COORDINATORGROUP_VIEW, FUELPRICE_VIEW, PARTNERTRANSACTION_VIEW, TMS_REWARDCOMPUTELIST_VIEW } from "../../../../../constants/functionLists";
...
class SearchCom extends React.Component {
    ...
    handleSearchSubmit(formData, MLObject) {
        const postData = [
            ...
            {
                SearchKey: "@USERNAME",
                SearchValue: MLObject.UserName != null && MLObject.UserName != -1 ? MLObject.UserName.value : -1
            },
            {
                SearchKey: "@TIMEKEEPINGMONTH",
                SearchValue: toIsoStringCus(new Date(MLObject.TimeKeepingMonth).toISOString())
            },
            // {
            //     SearchKey: "@ToDate",
        ...
        this.props.callFetchAPI(APIHostName, SearchAPIPath, searchData).then(apiResult => {
            ...
            if (apiResult && !apiResult.IsError) {
                ...
                const exelData = apiResult.ResultObject.map((item, index) => {
                    let element = {
                        "Tháng": item.TimeKeepingMonthString,
                        "Mã nhân viên": item.UserName,
                        "Tên nhân viên": item.FullName,
                        "Giờ công chuẩn": item.StandardManHour,
                        "Giờ công thực tế": item.TotalManHour,
                        "Thời điểm vượt": item.OTTimeString,
                    };
                    return element;
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    /> */}
                    <SearchForm
                        FormName="Tìm kiếm thông tin nhân viên vượt giờ công trong tháng"
                        MLObjectDefinition={SearchMLObjectDefinition}
                        listelement={SearchElementList}
                        onSubmit={this.handleSearchSubmit}
                    ...
                    <DataGrid
                        ...
                        ExportPermission={TMS_REWARDCOMPUTELIST_VIEW}
                        ...
                        fileName="Danh sách nhân viên vượt giờ công trong tháng"
