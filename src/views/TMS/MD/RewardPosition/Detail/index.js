...
import RewardPosition_RewardType from "../../RewardPosition_RewardType";
        ...
        if (this.state.IsLoadDataComplete && !this.state.IsCallAPIError) {
            return (
                <React.Fragment>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <span>Mã vị trí thưởng: </span>
                                            <span className="xcode">{this.state.DataSource.RewardPositionID}</span>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <span>Tên vị trí thưởng: </span>
                                            <span>{this.state.DataSource.RewardPositionName}</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <br />
                    <RewardPosition_RewardType
                        RewardPositionID={this.props.match.params.id}
                        RewardPosition_RewardType_DataSource={this.state.DataSource.ListRewardPosition_RewardType ? this.state.DataSource.ListRewardPosition_RewardType : []}
