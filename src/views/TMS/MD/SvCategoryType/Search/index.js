...
class SearchCom extends React.Component {
    ...
    callSearchData(searchData) {
        this.props.callFetchAPI(APIHostName, API_SvCategoryType_Search, searchData).then(apiResult => {
    ...
    handleDeleteClick(listDeleteID, ListPKColumnName) {
        ...
        const dataDelete = listDeleteID.map(item => {
            return {
                svCategoryTypeID: item.pkColumnName[0].value,
                DeletedUser: this.props.AppInfo.LoginInfo.Username
            }
        })

        this.props.callFetchAPI(APIHostName, API_SvCategoryType_DeleteList, dataDelete).then(apiResult => {
            ...
            return (
                <React.Fragment>
                    ...
                    <DataGrid
                        ...
                        listColumn={listColumn_Search}
                        onDeleteClick={this.handleDeleteClick}
                        PKColumnName={"svCategoryTypeID"}
                        ref={this.gridref}
                        RowsPerPage={50}
                    />
                </React.Fragment>
