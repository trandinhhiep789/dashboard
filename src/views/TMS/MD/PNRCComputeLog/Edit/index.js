                    ...
                    <div className="col-md-12 col-sm-12 col-xs-12">
                        <div className="x_panel">
                            <div className="x_title">
                                <h2>Nhật ký tính doanh thu phải thu đối tác</h2>
                            ...
                            <div className="x_content col-md-12">
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <span>Mã nhật ký tính doanh thu: </span>
                                            <span className="xcode">{this.state.DataSource.PNRCComputeLogID}</span>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <span>Mã lịch tính doanh thu: </span>
                                            <span className="xcode">{this.state.DataSource.PNRCComputeScheduleID}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            ...
                                            <span>{this.state.DataSource.ReceivableDateString}</span>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group checkbox customCheckbox">
                                            <span>Tính doanh thu bị lỗi: </span>
                                            <label>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            <span>Nội dung log tính doanh thu: </span>
