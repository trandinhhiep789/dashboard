...
import { SHIPMENTFEETYPE_ADD, MTRETURNREQUESTTYPE_ADD, QUALITYASSESSTYPE_ADD, DATAEXPORTTEMPLATE_ADD } from "../../../../../constants/functionLists";
    ...
    render() {
        ...
        return (
            <SimpleForm
                ...
                BackLink={BackLink}
                RequirePermission={DATAEXPORTTEMPLATE_ADD}
                ref={this.searchref}
            />
        );
    }
