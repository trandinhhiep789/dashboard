...
class AdvanceRequestType_SoTypeCom extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            IsCloseForm: false,
            AdvanceRequestType_SoType_DataSource: this.props.AdvanceRequestType_SoType_DataSource ? this.props.AdvanceRequestType_SoType_DataSource : [],
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.AdvanceRequestType_SoType_DataSource !== this.state.AdvanceRequestType_SoType_DataSource) {
            this.setState({ AdvanceRequestType_SoType_DataSource: nextProps.AdvanceRequestType_SoType_DataSource });
        }
    }
        ...
        return (
            <div className="sub-grid detail">
                <DataGrid listColumn={DataGridColumnList}
                    dataSource={this.state.AdvanceRequestType_SoType_DataSource}
                    modalElementList={ModalColumnList_Insert}
                    MLObjectDefinition={MLObjectDefinition}
                    IDSelectColumnName={"chkSelectShipmentOrderTypeID"}
                    PKColumnName={"ShipmentOrderTypeID"}
                    onDeleteClick={this.handleDelete}
                    onInsertClick={this.handleInsert}
                    IsAutoPaging={false}
                    //RowsPerPage={10}
                    IsCustomAddLink={true}
                    headingTitle={"Loại yêu cầu vận chuyển"}
                />
            </div>
        );
...
const AdvanceRequestType_SoType = connect(mapStateToProps, mapDispatchToProps)(AdvanceRequestType_SoTypeCom);
export default AdvanceRequestType_SoType;
