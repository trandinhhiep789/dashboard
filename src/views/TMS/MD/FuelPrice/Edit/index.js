...
import { AREATYPE_UPDATE, FUELPRICE_UPDATE } from "../../../../../constants/functionLists";
...
class EditCom extends React.Component {
    ...
    handleSubmit(formData, MLObject) {
        ...
        if (validDate == 1) {
            this.addNotification("Ngày khai báo bảng giá nhiên liệu không hợp lệ. Vui lòng kiểm tra lại.", true);
        } 
        else {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                ...
                <React.Fragment>
                    ...
                    <SimpleForm
                        FormName="Cập nhật bảng giá nhiên liệu"
                        ...
                        BackLink={BackLink}
                        RequirePermission={FUELPRICE_UPDATE}
                        ref={this.searchref}
                    />
                </React.Fragment>
            );
