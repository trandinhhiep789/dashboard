...
import { REWARDCOMPUTELOG_VIEW } from "../../../../../constants/functionLists";
    ...
    handleSearchSubmit(formData, MLObject) {
        const postData = [
            ...
            },
            {
                ...
                SearchValue: MLObject.LogActionType
            },
            {
        ...
        this.props.callFetchAPI(APIHostName, SearchAPIPath, searchData).then(apiResult => {
            ...
            if (apiResult && !apiResult.IsError) {
                let _data = apiResult.ResultObject.map((item, index) => {
                    item.ActionInterval = parseFloat((item.ActionInterval / 1000) % 60).toFixed(2);
                    return item;
                })
                this.setState({
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm nhật ký tính thưởng"
