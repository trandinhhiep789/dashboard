    ...
    callLoadData() {
        ...
        this.props.callFetchAPI(APIHostName, LoadAPIPath, id).then(apiResult => {
            if (apiResult.IsError) {
                ...
                const detailID = apiResult.ResultObject.MTReturnRequestTypeID;
                const DetailPagePath = [
                    { Link: "/", Title: "Trang chủ", icon: "fa fa-home" },
                    { Link: "/MTReturnRequestType", Title: "Loại yêu cầu nhập trả vật tư" },
                    { Link: "/MTReturnRequestType/Detail/" + detailID, Title: "Chi tiết yêu cầu nhập trả vật tư" },
                    { Link: "", Title: "Chi tiết mức duyệt yêu cầu nhập trả vật tư" }
                ];
                this.props.updatePagePath(DetailPagePath);
            }
            this.setState({
            ...
            return (
                <React.Fragment>
                    ...
                    <MTReturnRequestType_ReviewLevel_User
                        ...
                        DataSource={this.state.DataSource.ListMTReturnRequestType_ReviewLevel_User ? this.state.DataSource.ListMTReturnRequestType_ReviewLevel_User : []}
