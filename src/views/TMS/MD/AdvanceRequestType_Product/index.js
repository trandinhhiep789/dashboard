...
class AdvanceRequestType_ProductCom extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.AdvanceRequestType_Product_DataSource !== this.state.AdvanceRequestType_Product_DataSource) {
            this.setState({ AdvanceRequestType_Product_DataSource: nextProps.AdvanceRequestType_Product_DataSource });
        }
    }
...
const AdvanceRequestType_Product = connect(mapStateToProps, mapDispatchToProps)(AdvanceRequestType_ProductCom);
export default AdvanceRequestType_Product;
