...
export const AddAPIPath = "api/AdvanceRequestType_Product/Add";
export const UpdateAPIPath = "api/AdvanceRequestType_Product/Update";
export const DeleteAPIPath = "api/AdvanceRequestType_Product/Delete";
