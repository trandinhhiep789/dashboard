...
import { FUELPRICE_VIEW, FUELPRICE_DELETE, SERVICEPRICETABLE_VIEW, SERVICEPRICETABLE_DELETE } from "../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm bảng giá dịch vụ áp dụng"
