...
export const SearchAPIPath = "api/AppDataSyncLog/Search";
export const LoadAPIPath = "api/AppDataSyncLog/Load";
export const AddAPIPath = "api/AppDataSyncLog/Add";
export const UpdateAPIPath = "api/AppDataSyncLog/Update";
export const DeleteAPIPath = "api/AppDataSyncLog/Delete";
export const UpdateOrderAPIPath = "api/AppDataSyncLog/UpdateOrder";
export const BackLink = "/AppDataSyncLog";
export const AddLink = "/AppDataSyncLog/Add";
export const AddLogAPIPath = "api/UserActivity/Add";
export const IDSelectColumnName = "chkSelect";
export const PKColumnName = "AppDataSyncLogID";
export const PagePath = [
    { Link: "/", Title: "Trang chủ", icon: "fa fa-home" },
    { Link: "", Title: "Danh sách nhật ký đồng bộ dữ liệu từ BCNB" }
];

export const EditPagePath = [
    { Link: "/", Title: "Trang chủ", icon: "fa fa-home" },
    { Link: "/AppDataSyncLog", Title: "Danh sách nhật ký đồng bộ dữ liệu từ BCNB" },
    { Link: "", Title: "Sửa" }
];
...
export const SearchElementList = [
    ...
    // {
    //     type: "select",
    //     name: "slAppDataSyncLogTypeID",
    //     label: "Loại giao dịch",
    //     value: -1,
    //     placeholder: "",
    //     icon: "",
    //     listoption: [],
    //     DataSourceMember: "AppDataSyncLogTypeID",
    //     readonly: false,
    //     validatonList: [],
    //     IsAutoLoadItemFromCache: true,
    //     LoadItemCacheKeyID: "ERPCOMMONCACHE.AppDataSyncLogTYPE",
    //     ValueMember: "AppDataSyncLogTypeID",
    //     NameMember: "AppDataSyncLogTypeName"
    // },
    // {
    //     type: "select",
    //     name: "slPartnerID",
...
export const DataGridColumnList = [
    // {
    //     Name: "AppDataSyncLogID",
    //     Type: "texttolink",
    //     Caption: "Mã phụ cấp",
    //     Link: "/AppDataSyncLog/Edit/",
    //     DataSourceMember: "AppDataSyncLogID",
    //     //Width: 
    // },
    // {
    //     Name: "AppDataSyncLogTypeName",
    //     Type: "text",
    //     //Link: "/AppDataSyncLog/Edit/",
    //     Caption: "Loại giao dịch",
    //     DataSourceMember: "AppDataSyncLogTypeName",
    //     Width: 300
    // },
    {
