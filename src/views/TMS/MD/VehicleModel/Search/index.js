    ...
    if (this.state.IsShowForm) {
      return (
        <React.Fragment>
          ...
          <SearchForm FormName="Tìm kiếm danh sách model xe" MLObjectDefinition={SearchMLObjectDefinition} listelement={SearchElementList} onSubmit={this.handleSearchSubmit} ref={this.searchref} />
          <DataGrid
            ...
            ref={this.gridref}
            RequirePermission={MD_VEHICLEMODEL_VIEW}
            DeletePermission={MD_VEHICLEMODEL_DELETE}
            IsAutoPaging={true}
            RowsPerPage={10}
          />
        </React.Fragment>
