...
import { SHIPMENTORDERSTATUS_UPDATE } from "../../../../../constants/functionLists";
...
class EditCom extends React.Component {
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <SimpleForm
                    FormName="Cập nhật trạng thái yêu cầu vận chuyển"
                    ...
                    BackLink={BackLink}
                    RequirePermission={SHIPMENTORDERSTATUS_UPDATE}
                    ref={this.searchref}
                />
            );
        }
