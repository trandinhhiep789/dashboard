...
class BaseDeliveryAbilityCom extends React.Component {
    ...
    handleSearchSubmit(formData, MLObject) {
        this.callData(toIsoStringCus(new Date(MLObject.BaseDeliveryAbilityDate).toISOString()));
    }
    ...
    render() {
        return (
            <React.Fragment>
                <SearchForm
                    FormName="Tính tải chuẩn theo ngày"
...
const BaseDeliveryAbility = connect(mapStateToProps, mapDispatchToProps)(BaseDeliveryAbilityCom);
export default BaseDeliveryAbility;
