...
import { DELIVERYDATEUPDATEREASON_UPDATE } from "../../../../../constants/functionLists";
...
class EditCom extends React.Component {
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <SimpleForm
                    FormName="Cập nhật lý do cập nhật giờ giao hàng"
                    ...
                    BackLink={BackLink}
                    RequirePermission={DELIVERYDATEUPDATEREASON_UPDATE}
                    ref={this.searchref}
                />
            );
        }
