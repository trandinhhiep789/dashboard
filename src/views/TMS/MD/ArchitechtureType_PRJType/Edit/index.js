...
class EditCom extends React.Component {
    ...
    componentDidMount() {
        ...
        let _id = [id, id2];
        this.props.callFetchAPI(APIHostName, LoadAPIPath, _id).then(apiResult => {
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <SimpleForm
                    FormName="Cập nhật bảng Map loại mô hình và loại công trình"
                    ...
                    BackLink={BackLink}
                    RequirePermission={MAINTAINCONSTRUCT_UPDATE}
                    ref={this.searchref}
                />
            );
        }
