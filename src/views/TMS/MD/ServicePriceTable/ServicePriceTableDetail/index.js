...
import {
    ...
    APIHostName,
    AddAPIRPTDetailPath,
    MLObjectSPTDetailItem,
    AddAPISPTDetailPath,
    EditAPISPTDetailPath,

} from "../../ServicePriceTable/constants";
import { ERPCOMMONCACHE_SUBGROUP, ERPCOMMONCACHE_SUBGROUPTECHSPECS, ERPCOMMONCACHE_TECHSPECSVALUE, ERPCOMMONCACHE_MAINGROUP, ERPCOMMONCACHE_SERVICEGROUP } from "../../../../../constants/keyCache";
...
class ServicePriceTableDetailCom extends Component {
    constructor(props) {
        super(props);
                ...
                <div className="row">
                    ...
                    <div className="col-md-12">
                        <FormControl.FormControlTextBox
                            ...
                            readOnly={true}
                            hidenControll={true}
                            label="Mã bảng giá dịch vụ"
                            placeholder="Mã bảng giá dịch vụ"
                    ...
                    <div className="col-md-6">
                        <FormControl.FormControlComboBox
                            ...
                            loaditemcachekeyid={ERPCOMMONCACHE_SERVICEGROUP} //"ERPCOMMONCACHE.SERVICEGROUP"
...
const ServicePriceTableDetail = connect(mapStateToProps, mapDispatchToProps)(ServicePriceTableDetailCom);
export default ServicePriceTableDetail;