                        ...
                        <TabPage MLObjectDefinition={MLObjectDefinition} datasource={this.state.FormData.ShipmentOrderTypeWorkflow}
                            ...
                            <div className="form-row">
                                ...
                                <div className="col-sm-3">
                                    ...
                                    <FormControl.CheckBox labelcolspan={1} colspan={11} label="Là bước nhập trả vật tư nếu ko sử dụng" name="IsCreateMaterialReturnStep"
                                        controltype="InputControl" datasourcemember="IsCreateMaterialReturnStep"
                                        swaplabelModal={true}
                                    />
                                    ...
                                    <FormControl.CheckBox labelcolspan={1} colspan={11} label="Là bước cho phép tạo yêu cầu báo giá vật tư " name="IsMaterialQuotationStep"
                                        controltype="InputControl" datasourcemember="IsMaterialQuotationStep"
                                        swaplabelModal={true}
                                    />
