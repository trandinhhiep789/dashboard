...
class ShipmentOrderType_FixShipmentFeeCom extends React.Component {
    constructor(props) {
        super(props);
...
const ShipmentOrderType_FixShipmentFee = connect(mapStateToProps, mapDispatchToProps)(ShipmentOrderType_FixShipmentFeeCom);
export default ShipmentOrderType_FixShipmentFee;
