...
import { MD_LEADORDERTYPEPROCESS_UPDATE } from './../../../../../constants/functionLists';
...
class EditCom extends React.Component {
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <SimpleForm
                    FormName="Cập nhật phương thức xử lý mối bán hàng"
                    ...
                    BackLink={BackLink}
                    RequirePermission={MD_LEADORDERTYPEPROCESS_UPDATE}
                    ref={this.searchref}
                />
            );
        }
