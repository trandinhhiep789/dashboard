...
class DestroyRequestType_ReviewLevel_UserCom extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.DestroyRequestType_ReviewLevel_User_DataSource !== this.state.DestroyRequestType_ReviewLevel_User_DataSource) {
            this.setState({ DestroyRequestType_ReviewLevel_User_DataSource: nextProps.DestroyRequestType_ReviewLevel_User_DataSource });
        }
    }
    ...
    handleDelete(deleteList, pkColumnName) {
        ...
        let listMLObject = [];
        let _RV_User_DataSource = this.state.DestroyRequestType_ReviewLevel_User_DataSource;
...
const DestroyRequestType_ReviewLevel_User = connect(mapStateToProps, mapDispatchToProps)(DestroyRequestType_ReviewLevel_UserCom);
export default DestroyRequestType_ReviewLevel_User;
