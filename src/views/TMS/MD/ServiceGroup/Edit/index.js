...
import { REWARDTYPE_UPDATE, SERVICEGROUP_UPDATE, SERVICETYPE_UPDATE } from "../../../../../constants/functionLists";
...
class EditCom extends React.Component {
    ...
    render() {
        ...
        if (this.state.IsLoadDataComplete) {
            return (
                <SimpleForm
                    FormName="Cập nhật nhóm dịch vụ"
                    ...
                    BackLink={BackLink}
                    RequirePermission={SERVICEGROUP_UPDATE}
                    ref={this.searchref}
                />
            );
        }
