...
export const AddAPIPath = "api/MTReturnRequestType_ReviewLevel_User/Add";
export const UpdateAPIPath = "api/MTReturnRequestType_ReviewLevel_User/Update";
export const DeleteAPIPath = "api/MTReturnRequestType_ReviewLevel_User/Delete";
...
export const DataGridColumnList = [
    {
        Name: "chkSelectStoreID",
        Type: "checkbox",
        Caption: "Chọn",
        DataSourceMember: "StoreID,UserName",
        Width: 60
    },
    {
