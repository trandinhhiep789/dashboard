...
class AdvanceRequestType_ReviewLevel_UserCom extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            cssNotification: "",
            iconNotification: "",
            AdvanceRequestType_ReviewLevel_User_DataSource: this.props.AdvanceRequestType_ReviewLevel_User_DataSource ? this.props.AdvanceRequestType_ReviewLevel_User_DataSource : [],
            IsInsert: true,
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.AdvanceRequestType_ReviewLevel_User_DataSource !== this.state.AdvanceRequestType_ReviewLevel_User_DataSource) {
            this.setState({ AdvanceRequestType_ReviewLevel_User_DataSource: nextProps.AdvanceRequestType_ReviewLevel_User_DataSource });
        }
    }
    ...
    handleDelete(deleteList, pkColumnName) {
        ...
        let listMLObject = [];
        let _RV_User_DataSource = this.state.AdvanceRequestType_ReviewLevel_User_DataSource;
        ...
        return (
            <div className="sub-grid detail">
                ...
                <DataGrid listColumn={DataGridColumnList}
                    dataSource={this.state.AdvanceRequestType_ReviewLevel_User_DataSource}
...
const AdvanceRequestType_ReviewLevel_User = connect(mapStateToProps, mapDispatchToProps)(AdvanceRequestType_ReviewLevel_UserCom);
export default AdvanceRequestType_ReviewLevel_User;
