...
export const AddAPIPath = "api/AdvanceRequestType_ReviewLever_User/Add";
export const UpdateAPIPath = "api/AdvanceRequestType_ReviewLever_User/Update";
export const DeleteAPIPath = "api/AdvanceRequestType_ReviewLever_User/Delete";
