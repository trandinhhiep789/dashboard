...
import { DELIVERYDATEUPDATETYPE_VIEW, DELIVERYDATEUPDATETYPE_DELETE } from "../../../../../constants/functionLists";
        ...
        if (this.state.IsShowForm) {
            return (
                <React.Fragment>
                    ...
                    <SearchForm
                        FormName="Tìm kiếm loại cập nhật giờ giao hàng"
                    ...
                    <DataGrid
                        ...
                        ref={this.gridref}
                        RequirePermission={DELIVERYDATEUPDATETYPE_VIEW}
                        DeletePermission={DELIVERYDATEUPDATETYPE_DELETE}
                        IsAutoPaging={true}
                        RowsPerPage={10}
                    />
                </React.Fragment>
