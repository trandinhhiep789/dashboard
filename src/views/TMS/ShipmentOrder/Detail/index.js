                ...
                <div className="card">
                    <div className="card-body">
                        <div className="stepper">
                            ...
                            <div className="stepper-item step-waiting">
                    ...
                    <div className="card-body">
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-4">
                                <label className="col-form-label" >LO20040300000513</label>
                            </div><div className="form-group col-md-2">
                                <label className="col-form-label bold">Loại yêu cầu vận chuyển:</label>
                            </div>
                            <div className="form-group col-md-4">
                                <label className="col-form-label" >Giao hàng ĐMX</label>
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-group col-md-2">
                            ...
                            <div className="form-group col-md-4">
                                <label className="col-form-label" >Điện Máy Xanh</label>
                            </div>
                            <div className="form-group col-md-2">
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-4">
                                <label className="col-form-label" >Vận chuyển nhanh</label>
                            </div>
                            <div className="form-group col-md-2">
                                <label className="col-form-label bold">Phương tiện vận chuyển:</label>
                            </div>
                            <div className="form-group col-md-4">
                                <label className="col-form-label">Xe máy</label>
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-group col-md-2">
                            ...
                            <div className="form-group col-md-4">
                                <label className="col-form-label" >3/4/2020</label>
                            </div>
                            <div className="form-group col-md-2">
                                <label className="col-form-label bold">Thời gian giao dự kiến:</label>
                            </div>
                            <div className="form-group col-md-4">
                                <label className="col-form-label">3/4/2020 16:00</label>
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-group col-md-2">
                            ...
                            <div className="form-group col-md-4">
                                <label className="col-form-label" >3/4/2020 16:00  - 3/4/2020 17:30</label>
                            </div>
                            <div className="form-group col-md-2">
...
const Detail = connect(mapStateToProps, mapDispatchToProps)(DetailCom); export default Detail;
