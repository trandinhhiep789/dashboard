                    ...
                    <div className="form-group col-md-6">
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-2">
                                {this.state.SenderGeoLocation != "" ? "" : <button className="btn btnEditCard" onClick={this.handleSenderGeoLocation.bind(this)} type="submit">Lấy tọa độ</button>}
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-11">
                                            <label className="col-form-label">{this.state.ShipmentOrder.RequestStoreID + " - " + this.state.ShipmentOrder.RequestStoreName}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
