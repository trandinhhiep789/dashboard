export const TitleFormAdd = "Thêm chi tiết năng lực";
export const TitleFormEdit = "Cập nhật chi tiết năng lực";
export const TitleFormSearch = "Danh sách chi tiết năng lực";
