...
import MultiStoreSearchComboBox from "./../../../../common/components/FormContainer/FormControl/MultiSelectComboBox/MultiStoreSearchComboBox";
import MultiTreeSelect from "./../../../../common/components/FormContainer/FormControl/MultiSelectComboBox/MultiTreeSelect";
import ProductComboBox from "./../../../../common/components/FormContainer/FormControl/MultiSelectComboBox/ProductComboBox";
import MultiSelectUserComboBox from "./../../../../common/components/FormContainer/FormControl/MultiSelectComboBox/MultiSelectUserComboBox";
import { ValidationField } from "./../../../../common/library/validation";
import ElementSearch from "../../../../common/components/FormContainer/FormElement/ElementSearch";
import MultiTreeSelectByMGCOO from "../../../../common/components/FormContainer/FormControl/MultiSelectComboBox/MultiTreeSelectByMGCOO";
...
class SearchForm extends Component {
  ...
  handleSearchSubmit(event) {
    ...
    if (this.checkInputName(formValidation) != "") return;
      ...
      <div className="row">
        {listElement.map((elementItem, index) => {
          switch (elementItem.type) {
            ...
            case "ComboBoxFilterTwoCondition": // lọc theo 2 điều kiện: 1 theo field search khác, 2 là giá trị tự truyền vào
              if (typeof elementItem.filterName != "undefined") {
                elementItem.filterValue = this.state.FormData[elementItem.filterName].value;
              }
        ...
        <div className={classNamebtnSearch}>
          ...
          <div className={this.props.btnGroup ? this.props.btnGroup : "btnSearch btncustom"}>
            ...
            <button
              className={this.props.IsShowButtonSearch != undefined && this.props.IsShowButtonSearch == false ? "btnHide" : "btn btn-primary"}
              type="submit"
              disabled={this.props.IsDisabledBtnSearch}
            >
            ...
            </button>
            {
              ...
              this.props.IsButtonExport != undefined && this.props.IsButtonExport == true && (
                // && <button
                ...
                <button
                  type="button"
                  className={this.props.btnExport ? this.props.btnExport : "btn btn-label btn-info btn-export-cus  ml-1"}
                  onClick={this.handleExportSubmit.bind(this)}
                  disabled={this.props.IsDisabledBtnExport}
                >
                  <label>
            ...
            {this.props.IsButtonhistory == true && (
              ...
              // </button>
              <React.Fragment>
                <button data-tip data-for="btn-historyExport" data-id="btn-historyExport" type="button" onClick={this.handlehistorySubmit.bind(this)} className="btn btn-square btn-git ml-1">
  ...
  render() {
    ...
    if (this.props.className == undefined && this.props.className == "") {
      classNameCustom = "SearchForm";
    } else {
      classNameCustom = "SearchForm " + this.props.className;
    }
    return (
