...
class ListShipCoordinatorRouteNewUICom extends Component {
  constructor(props) {
    super(props);
...
const ListShipCoordinatorRouteNewUI = connect(mapStateToProps, mapDispatchToProps)(ListShipCoordinatorRouteNewUICom);
export default ListShipCoordinatorRouteNewUI;
