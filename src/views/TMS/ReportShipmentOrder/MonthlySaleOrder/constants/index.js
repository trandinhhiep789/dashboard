...
export const SearchAPIPath = "api/MonthlySaleOrder/SearchReport";
// export const SearchUnlockLogAPIPath = "api/MonthlySaleOrder_unLockLog/Search";
// export const SearchExportAPIPath = "api/MonthlySaleOrder/SearchExport";
// export const SearchWithinPaginationAPI = "api/MonthlySaleOrder/SearchNew";
// export const UpdateUnlockAPIPath = "api/MonthlySaleOrder/UpdateUnlock";
// export const SearchDetailAPIPath = "api/MonthlySaleOrderDetail/Search";
...
export const DataGirdMonthlySaleOrderColumnList = [
    {
...
export const DataGirdMonthlySaleOrderHistoryColumnList = [
    {
        Name: "FullName",
        Type: "text",
        Caption: "Mã NV",
...
export const DataGirdMonthlySaleOrderDetailHistoryColumnList = [
    {
        Name: "FullName",
        Type: "text",
        Caption: "Mã NV",
