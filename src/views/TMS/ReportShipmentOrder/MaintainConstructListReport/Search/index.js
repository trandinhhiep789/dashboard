...
class SearchCom extends React.Component {
    ...
    getCacheMTG() {
        this.props.callGetCache(ERPCOMMONCACHE_TMSCONFIG).then((result) => {
            if (result && !result.IsError && result.ResultObject) {
                let _configValue = result.ResultObject.CacheData.filter(x => x.TMSConfigID == "TEMPLATE_EXPORT_MAINTAINCONSTRUCTLIST");
                if (_configValue) {
                    this.setState({
    ...
    handleExportSubmit(formData, MLObject) {
        ...
        const postData = {
            ...
            LoadDataStoreName: 'TMS.TMS_MAINTAINCONSTRUCTLIST_RP',
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <SearchForm
                    FormName="Tìm kiếm công trình bảo trì"
