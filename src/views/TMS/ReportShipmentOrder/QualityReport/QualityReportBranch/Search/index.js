...
export class Search extends Component {
    ...
    callSearchTotalData() {
        ...
        this.props.callFetchAPI(APIHostName, "api/QualityAssessmentReport/TotalQualityReportBranch", SearchTotalData).then(apiResult => {
    ...
    handleExportSubmit(formData, MLObject) {
        ...
        const postData = {
            ...
            ExportDataParamsDescription: "FROMDATE: " + MLObject.FromDate + " - TODATE: " + MLObject.ToDate + " - RPTTYPE: " + 1 + " - AREAIDLIST: " + areaID + " - COORDINATORGROUPIDLIST: " + result2 + " - MAINGROUPIDLIST: " + mainGroupID + " - SUBGROUPIDLIST: " + result + " - ISDETAIL: " + 1 + " - PAGESIZE: " + "-1" + " - PAGEINDEX: " + "-1"
        }
