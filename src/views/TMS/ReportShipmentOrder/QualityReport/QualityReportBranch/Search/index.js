...
export class Search extends Component {
    ...
    handleExportSubmit(formData, MLObject) {
        ...
        const postData = {
            ...
            ExportDataParamsDescription: "FROMDATE: " + MLObject.FromDate + " - TODATE: " + MLObject.ToDate + " - RPTTYPE: " + 1 + " - AREAIDLIST: " + areaID + " - COORDINATORGROUPIDLIST: " + result2 + " - MAINGROUPIDLIST: " + mainGroupID + " - SUBGROUPIDLIST: " + result + " - PAGESIZE: " + "-1" + " - PAGEINDEX: " + "-1"
        }
