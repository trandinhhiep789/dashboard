                                ...
                                <table className="table table-sm table-striped table-bordered table-hover table-condensed">
                                    <thead className="thead-light">
                                        <tr>
                                            ...
                                            <th className="jsgrid-header-cell text-center" style={{ width: "13%" }} colSpan={4}>Tộng cộng {dataTotalSource.PercentageQuantityLike != undefined ? dataTotalSource.PercentageQuantityLike : 0} %</th>
