...
class DataGirdOrderStatisticsReportCom extends Component {
    constructor(props) {
        super(props);
        this.state = {
                                ...
                                dataSource.length > 0 ?
                                    ...
                                    dataSource.map((rowItem, rowIndex) => {
                                        return (<tr key={rowIndex}>
                                            <td style={{ width: '10%' }}>{rowItem.PartnerSaleOrderID}</td>
                                            <td style={{ width: '10%' }}>{rowItem.ShipmentOrderID}</td>
                                            <td style={{ width: '10%' }}>{rowItem.CreatedUser}</td>
                                            <td style={{ width: '10%' }}>{rowItem.CreatedOrderTime}</td>
                                            <td style={{ width: '10%' }}>{rowItem.CancelDeliveryUser}</td>
                                            <td style={{ width: '10%' }}>{rowItem.CancelDeliveryTime}</td>
                                            <td style={{ width: '10%' }}>{rowItem.CancelDeliveryReason}</td>
                                            {/* <td style={{ width: '10%' }}>{rowItem.IsOutPutGoods}</td> */}

                                            <td style={{ width: '10%' }}>
                                                <div className="checkbox">
                                                    <label>
                                                        <input type="checkbox" value={rowItem.IsOutPutGoods} checked={rowItem.IsOutPutGoods} className="form-control form-control-sm" />
                                                        <span className="cr" style={crtop}>
...
const DataGirdOrderStatisticsReport = connect(mapStateToProps, mapDispatchToProps)(DataGirdOrderStatisticsReportCom);
export default DataGirdOrderStatisticsReport;