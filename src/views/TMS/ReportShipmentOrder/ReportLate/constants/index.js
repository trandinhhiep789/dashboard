...
export const SearchAPIPath = "api/ShipmentOrder/SearchReportLate";
export const SearchReportLateDetailAPIPath = "api/ShipmentOrder/SearchReportLateDetail";
...
export const PagePath = [
    ...
    { Link: "", Title: "Danh sách thống kê vận đơn trễ" }
];
...
export const GridColumnList = [
    ...
    // },
    {
        Name: "TotalLate",
        Type: "text",
        Caption: "Tổng vận đơn trễ",
        DataSourceMember: "TotalLate",
        Width: '20%',
    },
    {
        Name: "TotalLate30",
        Type: "text",
        Caption: "Tổng vận đơn trễ dưới 30 phút",
        DataSourceMember: "TotalLate30",
        Width: '20%',
    },
    // {
