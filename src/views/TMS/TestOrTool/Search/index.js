            ...
            readXlsxFile(input.files[0], { sheet: "data", schema }).then((data) => {
                ...
                this.props.callFetchAPI("TMSAPI", "api/Routing/CapacityConstraints", input_1).then(apiResult => {
                    ...
                    if (apiResult.IsError) {
                        ...
                        objShipmentRouteAutoDataSource = { ...objShipmentRouteAutoDataSource, Motor: apiResult.ResultObject.MotorRoute, Truck: apiResult.ResultObject.TruckRoute }
                        changeState = { ...changeState, ShipmentRouteAutoDataSource: objShipmentRouteAutoDataSource };
                        this.setState(changeState)
                    }
                });
            }).catch(error => {
