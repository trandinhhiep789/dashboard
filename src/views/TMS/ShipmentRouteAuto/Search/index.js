      ...
      <React.Fragment>
        ...
        {this.state.IsLoadDataComplete && (
          <div className="col-lg-12">
            <Collapsible
              triggerStyle={{ width: "100%", borderRadius: "5px", position: "relative" }}
              trigger={
                <React.Fragment>
                  <span style={{ fontSize: "20px", fontWeight: "300" }}>Khung giờ 08h00 - 10h00</span>
                  <span style={{ position: "absolute", top: "50%", right: "30px", transform: "translateY(-50%)", fontSize: "16px" }}>Tồng số đơn: 10</span>
                </React.Fragment>
              }
              easing="ease-in"
              open={false}
            ...
            <Collapsible
              ...
              trigger={
                <React.Fragment>
                  <span style={{ fontSize: "20px", fontWeight: "300" }}>Khung giờ 10h00 - 12h00</span>
                  <span style={{ position: "absolute", top: "50%", right: "30px", transform: "translateY(-50%)", fontSize: "16px" }}>Tồng số đơn: 10</span>
                </React.Fragment>
              }
              easing="ease-in"
            ...
            <Collapsible
              ...
              trigger={
                <React.Fragment>
                  <span style={{ fontSize: "20px", fontWeight: "300" }}>Khung giờ 12h00 - 14h00</span>
                  <span style={{ position: "absolute", top: "50%", right: "30px", transform: "translateY(-50%)", fontSize: "16px" }}>Tồng số đơn: 10</span>
                </React.Fragment>
              }
              easing="ease-in"
            ...
            <Collapsible
              ...
              trigger={
                <React.Fragment>
                  <span style={{ fontSize: "20px", fontWeight: "300" }}>Khung giờ 14h00 - 16h00</span>
                  <span style={{ position: "absolute", top: "50%", right: "30px", transform: "translateY(-50%)", fontSize: "16px" }}>Tồng số đơn: 10</span>
                </React.Fragment>
              }
              easing="ease-in"
            ...
            <Collapsible
              ...
              trigger={
                <React.Fragment>
                  <span style={{ fontSize: "20px", fontWeight: "300" }}>Khung giờ 17h00 - 19h00</span>
                  <span style={{ position: "absolute", top: "50%", right: "30px", transform: "translateY(-50%)", fontSize: "16px" }}>Tồng số đơn: 10</span>
                </React.Fragment>
              }
              easing="ease-in"
            ...
            <Collapsible
              ...
              trigger={
                <React.Fragment>
                  <span style={{ fontSize: "20px", fontWeight: "300" }}>Khung giờ 19h00 - 21h00</span>
                  <span style={{ position: "absolute", top: "50%", right: "30px", transform: "translateY(-50%)", fontSize: "16px" }}>Tồng số đơn: 10</span>
                </React.Fragment>
              }
              easing="ease-in"
