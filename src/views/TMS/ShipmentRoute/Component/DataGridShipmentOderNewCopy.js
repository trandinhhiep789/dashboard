...
const dataGridShipmentOderNewCom = (props) => {
    ...
    const listPKColumn = pkColumnName.map(item => { return { key: item } });
                                                                ...
                                                                <li className="item ">
                                                                    <div className="group-action">
                                                                        <div className="checkbox item-action">
                                                                            <label>
                                                                                <input type="checkbox" readOnly className="form-control form-control-sm" name={"ShipmentOrderID"} onChange={handleCheckShip} value={rowItem.ShipmentOrderID} checked={gridDataShip.some(n => n.ShipmentOrderID == rowItem.ShipmentOrderID)} />
                                                                                <span className="cr">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li className="times">
                                                            <span className="group-times">
                                                                <ul>
                                                                    {_genCommentCarrierPartner(rowItem.CarrierTypeID, rowItem.CarrierTypeName)}
                                                                </ul>
        ...
        return (
            <div className="card card-shipment-order-mobile-view">
                ...
                <div>
                    {
                        props.IsAutoPaging &&
                        <GridPage numPage={pageCount} currentPage={PageNumber} onChangePage={onChangePageHandle} />
                    }
                </div>
            </div >
        )
                                                    ...
                                                    <div className="group-left">
                                                        ...
                                                        <div className="input-group input-group-select">
                                                            ...
                                                            <div className="input-group-append">
                                                                <span onClick={handleSearchShip} className="input-group-text"><i className="ti-search"></i></span>
                                                                <span onClick={() => handleChangeIsserver(changeIsserver)} className="input-group-text"><i className={changeIsserver==true ? "fa fa-eye" : "fa"}></i></span>
                                                            </div>
                                                        </div>
                                                    </div>
