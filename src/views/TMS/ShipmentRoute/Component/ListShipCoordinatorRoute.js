    ...
    return (
      <React.Fragment>
                            ...
                            return (
                              <div>
                                <tr key={index} className="jsgrid-row">
                                  ...
                                  <td className="jsgrid-cell group-products" style={{ width: "50%" }} onClick={() => this.handleNotifySubmit(item)}>
                                    <ul>
                                  ...
                                  <td className="jsgrid-cell " style={{ width: "5%", verticalAlign: "middle" }}>
                                ...
                                <tr className="jsgrid-row" style={{ display: this.state.isShowNotify ? "table-row" : "none" }}>
                                  <td style={{ width: "1%" }}></td>
                                  <td style={{ width: "50%" }}>
        ...
        <div className="modal-footer modal-footer-center">
          ...
          <button className="btn btn-w-md btn-round btn-info ml-10" type="button" onClick={this.handleConfirm.bind(this)}>
            Cập nhật
          </button>
        </div>
      </React.Fragment>
