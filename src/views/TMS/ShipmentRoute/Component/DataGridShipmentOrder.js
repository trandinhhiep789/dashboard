...
class DataGridShipmentOderCom extends Component {
  ...
  handleInsertClick() {
    if (this.props.onInsertClick != null) this.props.onInsertClick(this.props.MLObjectDefinition, this.props.modalElementList, this.props.dataSource);
  }
            ...
            <table id="fixtable" className="jsgrid-table">
              <thead className="jsgrid-header-row">
                <tr>
                  ...
                  <th className="jsgrid-header-cell" style={{ width: "28%" }}>
                    Địa chỉ
                  </th>
                  <th className="jsgrid-header-cell" style={{ width: "20%" }}>
                    Mã/Loại yêu cầu vận chuyển
                  </th>
                  <th className="jsgrid-header-cell" style={{ width: "25%" }}>
                    Tên sản phẩm/Ghi chú
                  </th>
                  <th className="jsgrid-header-cell" style={{ width: "8%" }}>
                    Thanh toán
                  </th>
                </tr>
              </thead>
                    ...
                    return (
                      <tr key={rowIndex} className={rowtrClass}>
                          ...
                          <div className="group-info">
                            <ul>
                              ...
                              <li className="item statusShipmentOder">
                                {rowItem.IsOutputGoods == false && rowItem.IsHandoverGoods == false ? (
                                  <span className="badge badge-danger active">Chưa xuất </span>
                                ) : (
                                  <span className="badge badge-danger noactive">Chưa xuất </span>
                                )}
                                {rowItem.IsOutputGoods == true && rowItem.IsHandoverGoods == false ? (
                                  <span className="badge badge-info active">Đã xuất </span>
                                ) : (
                                  <span className="badge badge-info noactive">Đã xuất </span>
                                )}
                        ...
                        <td className="jsgrid-cell group-price ssss" style={{ width: "8%" }}>
                          <ul>
                            <li className="item">{rowItem.IsCancelDelivery == true ? <span className="badge badge-danger">Đã hủy</span> : ""}</li>
                            <li className="item">{rowItem.TotalCOD > 0 ? <span className="item pricecod">COD:{formatMoney(rowItem.TotalCOD, 0)}</span> : ""}</li>
                            {rowItem.TotalSaleMaterialMoney > 0 ? (
                              <li className="item">
                                {" "}
                                <span className="price-supplies">Vật tư:{formatMoney(rowItem.TotalSaleMaterialMoney, 0)}</span>{" "}
                              </li>
                            ) : (
                              ""
                            )}
                            {rowItem.IsInputReturn == true ? (
                              <li className="item">
                                {" "}
                                <span className="price-supplies">Nhập trả:{formatMoney(rowItem.TotalReturnPrice, 0)}</span>{" "}
                              </li>
                            ) : (
                              ""
                            )}
                                ...
                                <span className="total">
                                  ...
                                  <span className="price-debt">
                                    ...
                                    {rowItem.TotalCOD - rowItem.TotalReturnPrice <= 0
                                      ...
                                      : formatMoney(rowItem.TotalSaleMaterialMoney + rowItem.TotalCOD - rowItem.TotalReturnPrice, 0)}
                                  </span>
                                </span>
                              </li>
                            )}
