...
import {MAX_PAGE_SHOW} from "../../../../constants/systemVars.js";
  ...
  render() {
    ...
    return (
        <nav>
                  ...
                  <li className="page-item"><strong>Trang({currentPage}/{numPage}):</strong> </li>
                  <li className={previousPageLICSS}>
                    ...
                    <li className={previousPageLICSS}>
                      <a className="page-link" data-pagenum={previousPage} data-linktext="previous" onClick={this.changePageHandle}>
...

                    {
                        pageArray.map((item) =>
                        {
                            if(item == currentPage)
                            {
                                return  <li className="page-item active" key={item}>
                                <a className="page-link" data-pagenum={item}  onClick={this.changePageHandle}>{item}</a>
                              </li>
                            }
                            else
                            {
                    ...
                    <li className={nextPageLICSS}>
                      <a className="page-link" id="next" data-pagenum={numPage} data-linktext="next"  onClick={this.changePageHandle} >
