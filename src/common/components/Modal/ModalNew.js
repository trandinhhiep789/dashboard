...
class ModalNewCom extends React.Component {
    constructor(props) {
        super(props);
...
const ModalNew = connect(mapStateToProps, mapDispatchToProps)(ModalNewCom);
