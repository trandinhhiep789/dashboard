import {REGISTER_CLIENT_REQUEST,  REGISTER_CLIENT_SUCCESS, REGISTER_CLIENT_FAILURE,
    REGISTER_CLIENT_LOAD_FROM_LOCAL}  from "../constants/actionTypes";
...
export function callRegisterClient(hostname,username, password)
{
    return (dispatch, getState) => 
    {
        ...
        return db.get(hostname).then((result) => 
            {
                if(result !=null)
                {
